...
gantt
    ...
    WBS                        :active,  p1b, 2026-05-26, 2026-05-27
    진행 관리 체계 수립         :         p1c, 2026-05-28, 2026-05-31

    section Phase 2 기획 문서 (W3)
    마켓리서치 + 서비스기획서   :         p2a, 2026-06-01, 2026-06-02
    요구사항정의서 + 기능명세서  :         p2b, 2026-06-02, 2026-06-04
    API스펙 + 정보구조도        :         p2c, 2026-06-04, 2026-06-05
    화면설계서                  :         p2d, 2026-06-04, 2026-06-07
    M1 기획 완료               :milestone, m1, 2026-06-07, 0d

    section Phase 3 구현 설계 (W4)
    인프라·시스템·DB 설계서     :         p3a, 2026-06-08, 2026-06-10
    디자인스타일가이드           :         p3b, 2026-06-08, 2026-06-09
    중간보고서                  :         p3c, 2026-06-10, 2026-06-12
    M2 설계 완료               :milestone, m2, 2026-06-14, 0d

    section Phase 3 개발 구현 (W4)
    환경 셋업 + 공통 기능       :         p4a, 2026-06-08, 2026-06-09
    부모님 화면 (Parent View)   :         p4b, 2026-06-09, 2026-06-11
    가족 화면 (Family View)     :         p4c, 2026-06-10, 2026-06-13
    관리자 화면 (Admin View)    :         p4d, 2026-06-10, 2026-06-13
    반응형·PWA + MVP 배포       :         p4e, 2026-06-13, 2026-06-14
...
| 1.2.1 | 3 | WBS Level 3 작성 | PM | 1.0 | 05-26 | 05-26 | WBS.md | 진행 중 |
| 1.2.2 | 3 | GitHub Milestones 및 Labels 설정 | PM | 0.5 | 05-27 | 05-27 | GitHub Milestones | 예정 |
| 1.3 | 2 | 진행 관리 체계 수립 | PM | 1.0 | 05-28 | 05-31 | | |
| 1.3.1 | 3 | GitHub Issues 일괄 생성 (WBS 기반) | PM | 0.5 | 05-28 | 05-28 | GitHub Issues | 예정 |
| 1.3.2 | 3 | 주간보고서 1호 발행 (W1-W2 기준) | PM | 0.5 | 05-29 | 05-29 | 주간보고서.md | 예정 |
...
| 2.1.1 | 3 | 마켓리서치 작성 (경쟁사 분석, 사용자 조사) | PM | 1.0 | 06-01 | 06-01 | 마켓리서치.md | 예정 |
| 2.1.2 | 3 | 서비스기획서 작성 | PM | 1.0 | 06-02 | 06-02 | 서비스기획서.md | 예정 |
| 2.2 | 2 | 요구사항 정의 | PM, BE | 3.0 | 06-02 | 06-04 | | |
| 2.2.1 | 3 | 요구사항정의서 작성 (기능/비기능) | PM | 1.0 | 06-02 | 06-02 | 요구사항정의서.md | 예정 |
| 2.2.2 | 3 | 기능명세서 작성 (CMN/PAR/FAM/ADM) | PM, BE | 1.5 | 06-03 | 06-03 | 기능명세서.md | 예정 |
| 2.2.3 | 3 | 기능명세서 검토 및 확정 (M1 전제조건) | PM | 0.5 | 06-04 | 06-04 | 기능명세서 확정본 | 예정 |
| 2.3 | 2 | 설계 기획 (기능명세서 완료 후 병렬 실행) | BE, UX, PM | 9.0 | 06-04 | 06-07 | | |
| 2.3.1 | 3 | API스펙 작성 (REST + WebSocket 엔드포인트) | BE | 1.5 | 06-04 | 06-05 | API스펙.md | 예정 |
| 2.3.2 | 3 | 정보구조도 작성 (화면 계층 + 메뉴 구조) | PM, UX | 1.0 | 06-04 | 06-04 | 정보구조도.md | 예정 |
| 2.3.3 | 3 | 화면설계서 작성 (부모님/가족/관리자 전 화면) | UX | 3.0 | 06-04 | 06-06 | 화면설계서.md | 예정 |
| 2.3.4 | 3 | 화면설계서 검토 및 피드백 반영 | UX, PM | 1.0 | 06-06 | 06-07 | 화면설계서 확정본 | 예정 |
| 2.3.5 | 3 | 주간보고서 2호 발행 | PM | 0.5 | 06-05 | 06-05 | 주간보고서.md | 예정 |
| 2.3.6 | 3 | **M1: 기획 완료 검토** | PM | 0.5 | 06-07 | 06-07 | M1 체크리스트 | 예정 |
...
| 3.1.1 | 3 | 인프라아키텍처 작성 (Vercel + Supabase 구성) | BE | 1.0 | 06-08 | 06-08 | 인프라아키텍처.md | 예정 |
| 3.1.2 | 3 | 시스템정의서 작성 (컴포넌트 + 통신 흐름) | BE | 1.0 | 06-08 | 06-09 | 시스템정의서.md | 예정 |
| 3.1.3 | 3 | 데이터베이스설계서 작성 (ERD + 테이블 정의) | BE | 1.5 | 06-09 | 06-10 | 데이터베이스설계서.md | 예정 |
| 3.1.4 | 3 | DB 스키마 Supabase 적용 | BE | 0.5 | 06-10 | 06-10 | Supabase 테이블 | 예정 |
| 3.2 | 2 | UX/UI 설계 가이드 | UX | 2.0 | 06-08 | 06-09 | | |
| 3.2.1 | 3 | 디자인 토큰 정의 (색상·타이포·간격) | UX | 1.0 | 06-08 | 06-08 | 디자인스타일가이드.md | 예정 |
| 3.2.2 | 3 | 컴포넌트 스타일 가이드 (버튼·입력·카드) | UX | 1.0 | 06-09 | 06-09 | 디자인스타일가이드.md | 예정 |
| 3.3 | 2 | 중간보고 | PM | 1.5 | 06-10 | 06-12 | | |
| 3.3.1 | 3 | 중간보고서 작성 | PM | 1.0 | 06-10 | 06-11 | 중간보고서.md | 예정 |
| 3.3.2 | 3 | 주간보고서 3호 발행 | PM | 0.5 | 06-12 | 06-12 | 주간보고서.md | 예정 |
...
| 4.2.1 | 3 | 회원가입 / 로그인 (휴대폰 번호 + OTP 인증) | FE, BE | 1.5 | 06-08 | 06-09 | CMN-01 구현 | 예정 |
| 4.2.2 | 3 | 가족 그룹 생성 및 코드 연결 | FE, BE | 1.0 | 06-09 | 06-09 | CMN-02 구현 | 예정 |
| 4.2.3 | 3 | 위치정보 수집 동의 처리 | FE | 0.5 | 06-09 | 06-09 | CMN-04 구현 | 예정 |
| 4.3 | 2 | 부모님 화면 (Parent View) | FE, BE | 5.0 | 06-09 | 06-11 | | |
| 4.3.1 | 3 | 메인 화면 SOS 버튼 UI (시니어 UX 적용) | FE | 1.0 | 06-09 | 06-10 | PAR-02 구현 | 예정 |
| 4.3.2 | 3 | GPS 실시간 위치 공유 (WebSocket 송신, 30초 간격) | FE, BE | 1.5 | 06-10 | 06-11 | PAR-01 구현 | 예정 |
| 4.3.3 | 3 | SOS 알림 발송 + FCM 연동 | BE | 1.0 | 06-10 | 06-11 | PAR-04 구현 | 예정 |
| 4.3.4 | 3 | 오조작 방지 로직 (2초 카운트다운) | FE | 0.5 | 06-11 | 06-11 | PAR-03 구현 | 예정 |
| 4.3.5 | 3 | 부모님 설정 페이지 (알림·위치 권한) | FE | 1.0 | 06-11 | 06-11 | 설정 화면 | 예정 |
| 4.4 | 2 | 가족 화면 (Family View) | FE, BE | 7.5 | 06-10 | 06-13 | | |
| 4.4.1 | 3 | 카카오맵 실시간 위치 지도 + 주소 표시 | FE | 1.5 | 06-10 | 06-11 | FAM-01 구현 | 예정 |
| 4.4.2 | 3 | FCM 긴급 알림 수신 + 인앱 팝업 | FE | 1.0 | 06-11 | 06-11 | FAM-05 구현 | 예정 |
| 4.4.3 | 3 | 바로 전화 연결 버튼 (tel: 링크) | FE | 0.5 | 06-11 | 06-11 | FAM-03 구현 | 예정 |
| 4.4.4 | 3 | 마지막 확인 시각 표시 | FE | 0.5 | 06-12 | 06-12 | FAM-06 구현 | 예정 |
| 4.4.5 | 3 | 위치 이력 조회 지도 (최대 7일) | FE, BE | 1.5 | 06-12 | 06-12 | FAM-02 구현 | 예정 |
| 4.4.6 | 3 | 가족 채팅방 (Socket.io 실시간 채팅) | FE, BE | 2.0 | 06-12 | 06-13 | FAM-04 구현 | 예정 |
| 4.5 | 2 | 관리자 화면 (Admin View) | FE, BE | 4.5 | 06-10 | 06-13 | | |
| 4.5.1 | 3 | 회원(가족 그룹) 목록 · 상세 조회 | FE, BE | 1.0 | 06-10 | 06-10 | ADM-01, ADM-02 구현 | 예정 |
| 4.5.2 | 3 | 회원 검색·필터 + 계정 정지/복구 | FE, BE | 1.0 | 06-11 | 06-11 | ADM-03, ADM-08 구현 | 예정 |
| 4.5.3 | 3 | SMS 발송 기능 (NHN Cloud 연동) | FE, BE | 1.0 | 06-12 | 06-12 | ADM-04 구현 | 예정 |
| 4.5.4 | 3 | 카카오 알림톡 발송 (API 연동) | FE, BE | 1.0 | 06-12 | 06-13 | ADM-05 구현 | 예정 |
| 4.5.5 | 3 | 발송 이력 조회 | FE, BE | 0.5 | 06-13 | 06-13 | ADM-06 구현 | 예정 |
| 4.6 | 2 | 반응형 및 PWA 설정 | FE | 1.0 | 06-13 | 06-14 | | |
| 4.6.1 | 3 | 모바일(360px~) 반응형 레이아웃 검증 | FE | 0.5 | 06-13 | 06-13 | 반응형 CSS | 예정 |
| 4.6.2 | 3 | PWA 설정 (manifest.json, service worker) | FE | 0.5 | 06-14 | 06-14 | PWA 설정 파일 | 예정 |
| 4.7 | 2 | MVP 통합 배포 | FE, BE | 1.0 | 06-14 | 06-14 | | |
| 4.7.1 | 3 | Vercel 스테이징 배포 + 연결 검증 | BE | 0.5 | 06-14 | 06-14 | 스테이징 URL | 예정 |
| 4.7.2 | 3 | **M3: 개발 완료 검토 (P0 기능 전체 확인)** | PM | 0.5 | 06-14 | 06-14 | M3 체크리스트 | 예정 |
