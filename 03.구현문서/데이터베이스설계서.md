...
| 최종 수정일 | 2026-06-08 |
| 작성자 | PM |
| 참조 문서 | 기능명세서.md (v1.2), API스펙.md (v1.1) |
...
users와 groups의 N:M 매핑. 그룹 내 역할(owner/member) 구분. 관련 기능: F-003, F-004, F-016, F-023, F-030.
...
| relation | VARCHAR(20) | NULL | NULL | 가족이 지정한 부모님 호칭 (어머니/아버지 등, 1~20자). NULL=미지정 (F-030) |
...
| v1.1 | 2026-06-08 | PM | 프론트엔드 구현 동기화 — group_members에 relation(부모님 호칭, F-030) 컬럼 추가 |
